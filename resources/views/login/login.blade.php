    ...
    <section class="vh-100" style="background-color: #508bfc;">
        <form action="" method="post">
            ...
            <div class="container py-5 h-100">
                ...
                <input class="form-check-input" type="radio" value="cust" id="form1Example3" name="role"/>
                <label class="form-check-label" for="form1Example3"> Customer </label>
                <input class="form-check-input" type="radio" value="admin" id="form1Example3" name="role"/>
                <label class="form-check-label" for="form1Example3"> Admin </label>
                <input class="form-check-input" type="radio" value="s_admin" id="form1Example3" name="role"/>
